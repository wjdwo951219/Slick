...
public class JFearAndGreed extends TableImpl<FearAndGreedRecord> {
    ...
    /**
     * The column <code>786b676a8e45.FEAR_AND_GREED.DATETIME</code>.
     */
    public final TableField<FearAndGreedRecord, LocalDateTime> DATETIME = createField(DSL.name("DATETIME"), SQLDataType.LOCALDATETIME(0).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.FEAR_AND_GREED_FEAR_AND_GREED_DATETIME_IDX);
    }
